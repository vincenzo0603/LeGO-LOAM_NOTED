...
// Save pcd
// extern const string fileDirectory = "/home/vincent/learning_node/slam/LeGO-LOAM/output/";
...
extern const bool loopClosureEnableFlag = false;    // 回环检测线程开关
...
extern const float sensorMinimumRange = 1.0;    // 过滤小于1m之内的点云
...
extern const int   historyKeyframeSearchNum = 25;               // 回环点云查找范围[-25, 25]   ||  2n+1 number of hostory key frames will be fused into a submap for loop closure
